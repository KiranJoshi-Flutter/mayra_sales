...
//
//     final premiumProductsModel = premiumProductsModelFromJson(jsonString);

import 'dart:convert';

PremiumProductsModel premiumProductsModelFromJson(String str) =>
    PremiumProductsModel.fromJson(json.decode(str));

String premiumProductsModelToJson(PremiumProductsModel data) =>
    json.encode(data.toJson());

class PremiumProductsModel {
  PremiumProductsModel({
    this.status,
    this.details,
  });
  ...
  factory PremiumProductsModel.fromJson(Map<String, dynamic> json) =>
      PremiumProductsModel(
        status: json["status"],
        details:
