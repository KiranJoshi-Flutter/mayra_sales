...
//                                 (BuildContext context, StateSetter setState) {
//                               if (snapshot.data[0].size != null) {
//                                 if (snapshot.data[0].size != "") {
//                                   return Padding(
//                                       padding: EdgeInsets.symmetric(
//                                           vertical: 8.0, horizontal: 16.0),
//                                       child: _sizeChooserExpand(
//                                           snapshot.data[0].size));
//                                 } else {
//                                   return Container();
//                                 }
...
//                           //_sizeChooserExpand(snapshot.data[0].size),
//                           // ExpansionTile(
//                           //   title: Text(
//                           //     AppLocalizations.of(context)
...
//                                 child: ListTile(
//                                   title: Text("SKU"),
//                                   subtitle: Text(snapshot.data[0].sku),
//                                 ),
//                               ),
//                             ],
//                           ),
                          ...
                          //         child: Html(data: snapshot.data[0].details),
                          //         // child: RichText(
                          //         //   text: TextSpan(
...
//   _colorChooserExpand(List<dynamic> colors) {
//     if (colors != null) {
//       return _colorChooser(colors);
//     }
//   }

//   _sizeChooserExpand(List<dynamic> sizes) {
//     if (sizes != null) {
//       return _sizeChooser(sizes);
//     }
//   }
